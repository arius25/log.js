...
var Log = exports = module.exports = function Log(level, stream, dbConn){
...
Log.prototype = {
  ...
  log: function(levelStr, args) {
    if (exports[levelStr] <= this.level) {
      ...
      if (this.stream.type == 'db') {
        this.stream.connection.query('insert into socialscrape_logging(log) values(' + msg + ')', function(err) {
            this.stream.write(
                '[' + new Date + ']'
                    + ' ' + levelStr
                    + ' ' + err
